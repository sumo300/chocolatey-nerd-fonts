...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/Cousine.zip'
  checksumType   = 'sha256'
  checksum       = 'FE3FFF65E38FB80E0EE203C093667E511CE65F2E2980B57EDF12D38E88831278'
}
