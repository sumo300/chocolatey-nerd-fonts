...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/Cousine.zip'
  checksumType   = 'sha256'
  checksum       = 'AC70139A1BAF9907169EE5EB78729E6A8EA1FBE3E9AADD6F30A4EBE4894BED63'
}
