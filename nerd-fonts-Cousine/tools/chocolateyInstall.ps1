...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/Cousine.zip'
  checksumType   = 'sha256'
  checksum       = 'F05F3E685900025E8BD034EA18F83026A53B83491B910228ABE4B81B3650781F'
}
