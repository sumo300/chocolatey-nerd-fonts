...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/SourceCodePro.zip'
  checksumType   = 'sha256'
  checksum       = '0D9280C77C6C833CEFB297BF2D84AB960123AB60D3F15F38231CA076B60CD283'
}
