...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/SourceCodePro.zip'
  checksumType   = 'sha256'
  checksum       = 'AB3EF453FBDDD71486FAD378D5F1697C5D9FF5871959E792BCA52B1353E0815D'
}
