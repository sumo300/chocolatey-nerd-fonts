...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/MartianMono.zip'
  checksumType   = 'sha256'
  checksum       = 'ACC4CFC26D4D4934EC0C0239BF456469768DC114174A0D38660A4E6C210A3B75'
}
