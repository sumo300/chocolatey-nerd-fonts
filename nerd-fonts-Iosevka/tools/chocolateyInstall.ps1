...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/Iosevka.zip'
  checksumType   = 'sha256'
  checksum       = 'DB0DA65EAB467FE21E874EDE4825D728A2562DC89B158A2F60D0E360F574F527'
}
