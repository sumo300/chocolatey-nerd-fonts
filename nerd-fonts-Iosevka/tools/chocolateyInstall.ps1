...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.1/Iosevka.zip'
  checksumType   = 'sha256'
  checksum       = '2371C5B0457436BE6376B01AD7C55D99F88C0E22D28A7586E5BC8F3450782185'
}
