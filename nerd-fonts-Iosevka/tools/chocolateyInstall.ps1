...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/Iosevka.zip'
  checksumType   = 'sha256'
  checksum       = 'A5A218F974C7D3264C0F330C514364AACABF839D8EE92ABD05F5C2CD4AD514B5'
}
