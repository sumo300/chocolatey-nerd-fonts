...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/Iosevka.zip'
  checksumType   = 'sha256'
  checksum       = '99E79487B945A4FB4BE5EE53D92FB9835A3E1E4636DA2F9B637AF0DAB9F4CF84'
}
