...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/UbuntuMono.zip'
  checksumType   = 'sha256'
  checksum       = 'F821517DCEC374EDA38BC82012AC792E65CFC9C43DB3C0D5DE119EB974F484AD'
}
