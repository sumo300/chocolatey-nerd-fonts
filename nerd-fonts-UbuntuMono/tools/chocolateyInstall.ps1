...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/UbuntuMono.zip'
  checksumType   = 'sha256'
  checksum       = '2966DF5B69CCF3642103C5041297CF1C648B20232D56019249978A76BE018A81'
}
