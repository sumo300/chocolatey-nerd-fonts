...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/UbuntuMono.zip'
  checksumType   = 'sha256'
  checksum       = '8C0C3FF230BBEAE44788D7A2D834AB1A92443A39A772D242FF021454D5904EBD'
}
