...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.1/Lekton.zip'
  checksumType   = 'sha256'
  checksum       = '1F4489DDC3FED6F008684D52A10D60F0D0C4B90062A77A00C56F8278A2678958'
}
