...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/Lekton.zip'
  checksumType   = 'sha256'
  checksum       = '41358A62E4762C229050AE0D4F7D1A579E2BB2B2DBE284845E25F39590322B22'
}
