...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/LiberationMono.zip'
  checksumType   = 'sha256'
  checksum       = '15DB9BFD43C2A7D865E60BA7B07CE4AE68D2365739060510C524F7902DAFA2CF'
}
