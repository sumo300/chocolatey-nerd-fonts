...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/LiberationMono.zip'
  checksumType   = 'sha256'
  checksum       = '4466E29A9F2C9EF9C8E8D74F1F755B0ACA47C42506B31530CF6744EF4BD01480'
}
