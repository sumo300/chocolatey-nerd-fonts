...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/LiberationMono.zip'
  checksumType   = 'sha256'
  checksum       = '1F396A501FBE447F85A3396B54A5FC37EBCF00335D0280ECCA1E251286722BE2'
}
