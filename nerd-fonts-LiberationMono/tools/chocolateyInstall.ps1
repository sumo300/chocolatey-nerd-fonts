...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/LiberationMono.zip'
  checksumType   = 'sha256'
  checksum       = 'A2CD3472F4F110AEBB96A318CEA6FD18903E7318D7A4A1F08DC9AEEE50446626'
}
