...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/AnonymousPro.zip'
  checksumType   = 'sha256'
  checksum       = 'E4525246A16369E4DD867BA868CD758E4B443CE0545B987A96D0A2236E20517F'
}
