...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/AnonymousPro.zip'
  checksumType   = 'sha256'
  checksum       = '4C88EFBB2C9EB350EC3117B7F5993C432624D7EFBD5A54F3717793525CEE98E6'
}
