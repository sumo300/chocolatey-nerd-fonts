...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/AnonymousPro.zip'
  checksumType   = 'sha256'
  checksum       = 'D4DF266159BCFEB4AEDC3EB78373D0140D6F5BF4ED8E08D5E068F679DA57E374'
}
