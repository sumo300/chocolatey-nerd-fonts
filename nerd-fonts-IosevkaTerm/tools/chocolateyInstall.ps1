...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/IosevkaTerm.zip'
  checksumType   = 'sha256'
  checksum       = '4A87ADE2CC568BBD6EC1DD9D179675C53CFEC22865063520AE93817FBA83A9C9'
}
