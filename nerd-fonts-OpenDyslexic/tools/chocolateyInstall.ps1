...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.1/OpenDyslexic.zip'
  checksumType   = 'sha256'
  checksum       = 'CACBF7973646252CBBF636F041A03D3F4FE409A43AA788937DD492CD3E947A1F'
}
