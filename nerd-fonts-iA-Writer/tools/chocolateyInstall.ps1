...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/iA-Writer.zip'
  checksumType   = 'sha256'
  checksum       = '33A4F211D1538597017C5ADC766CD5DC03BCD847C70788924E95208EA0DFB3C5'
}
