...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.1/iA-Writer.zip'
  checksumType   = 'sha256'
  checksum       = '89697338C3E83F9E90732BF06FD3DE173EC04D3325950FEC8EC4814B8899C1D9'
}
