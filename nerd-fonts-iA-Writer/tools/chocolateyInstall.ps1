...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/iA-Writer.zip'
  checksumType   = 'sha256'
  checksum       = 'FA546B33228790C25D640C067976F028F50AE761EBE23F305EC9E67BF292CF10'
}
