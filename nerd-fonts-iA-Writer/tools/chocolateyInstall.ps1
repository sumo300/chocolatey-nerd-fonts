...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/iA-Writer.zip'
  checksumType   = 'sha256'
  checksum       = 'C206811B084D912620608840E1290B9AFDADB8C908AC8890DF053BBE7496921C'
}
