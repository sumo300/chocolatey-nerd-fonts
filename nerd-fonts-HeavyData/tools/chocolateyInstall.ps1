...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.1/HeavyData.zip'
  checksumType   = 'sha256'
  checksum       = '36B219A2325280EF066917671B567F5995343E5C6E90B5364F0FBB681B93F27F'
}
