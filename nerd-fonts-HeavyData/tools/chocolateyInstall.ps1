...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/HeavyData.zip'
  checksumType   = 'sha256'
  checksum       = 'C0C98E8C91C53381842AC3135AD3A1F09134A3279A059EB04DD8D5A83FA9765E'
}
