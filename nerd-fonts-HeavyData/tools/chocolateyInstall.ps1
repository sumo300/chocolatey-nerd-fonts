...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/HeavyData.zip'
  checksumType   = 'sha256'
  checksum       = '611EF699B3C0966F50DE8C1AF5EC72BD63A8681E4E96D5AFB425DD23ECB81992'
}
