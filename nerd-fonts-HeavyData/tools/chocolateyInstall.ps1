...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/HeavyData.zip'
  checksumType   = 'sha256'
  checksum       = 'AF2B01D57C823FE0F144DF8268DB0D537EF45798E8913F80675635ED518B333A'
}
