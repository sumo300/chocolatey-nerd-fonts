...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/HeavyData.zip'
  checksumType   = 'sha256'
  checksum       = 'B82AE15B023506FD8C9A1BBFB199DAE845E2AAA20E4401081EA8A15E09A41E78'
}
