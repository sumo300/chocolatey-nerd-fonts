...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/Go-Mono.zip'
  checksumType   = 'sha256'
  checksum       = '250EC0A5C9529EE27F97948A928D105D8388BFA455CBA6EE2BDB19E3DE55DB6B'
}
