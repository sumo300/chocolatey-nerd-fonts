...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/Go-Mono.zip'
  checksumType   = 'sha256'
  checksum       = '3051F7918E54FB990B86BEDDC1EFD2268EA9F72C2C9993B2CEA3BA78D6685BD2'
}
