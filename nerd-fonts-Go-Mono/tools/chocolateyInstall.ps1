...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/Go-Mono.zip'
  checksumType   = 'sha256'
  checksum       = '85862C3A7816BB33EC7D4A5066E7E90F59283301CE306A42159DD8C64EA8FDA7'
}
