...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/Go-Mono.zip'
  checksumType   = 'sha256'
  checksum       = 'C58440C93E674530D224CF61D9603CBA9938BB4412DD2F2947819B9A052C3616'
}
