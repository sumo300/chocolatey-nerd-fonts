...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/ComicShannsMono.zip'
  checksumType   = 'sha256'
  checksum       = '1F0DCBC4E0A6FA25E634587D1AEE6EDAAB5C84662F800D079E6B99EC855A60E6'
}
