...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/ComicShannsMono.zip'
  checksumType   = 'sha256'
  checksum       = '166AE17FC8351401D2B3B75BB6E9797077DFDEE5AA275217F6A4B0E31A027327'
}
