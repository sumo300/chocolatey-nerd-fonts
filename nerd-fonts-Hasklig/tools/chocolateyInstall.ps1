...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/Hasklig.zip'
  checksumType   = 'sha256'
  checksum       = 'E4235CA3C1ADCF7F7E5756695C79C4226AE7D625E19F4827F142E2758A044317'
}
