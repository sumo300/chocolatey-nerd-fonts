...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/Hasklig.zip'
  checksumType   = 'sha256'
  checksum       = 'A6825DB98CC521DAB0C18766E28C662C6F1A3EBD36E40E8B191942AD3BD439F9'
}
