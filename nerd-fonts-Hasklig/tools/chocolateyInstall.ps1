...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/Hasklig.zip'
  checksumType   = 'sha256'
  checksum       = 'BDE1C136F941AE81A83A8B17CAB92199D14DC382F043F70C8309B7072D02BC60'
}
