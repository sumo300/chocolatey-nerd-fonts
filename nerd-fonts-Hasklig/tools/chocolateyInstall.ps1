...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/Hasklig.zip'
  checksumType   = 'sha256'
  checksum       = '59F5152D6741507A62367867108B2E91BDB04233534A2A221E349957CCB00C3E'
}
