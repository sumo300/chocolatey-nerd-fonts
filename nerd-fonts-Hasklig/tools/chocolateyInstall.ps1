...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/Hasklig.zip'
  checksumType   = 'sha256'
  checksum       = 'D6EEF7D933391FE63BAC4949C55D5228EDB48DEBDE53AC30D31A1C26C6181805'
}
