...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/Ubuntu.zip'
  checksumType   = 'sha256'
  checksum       = 'FAD098ACAE959197FBC092F0A0E18024E5170E4F0F7910E546325DD510892221'
}
