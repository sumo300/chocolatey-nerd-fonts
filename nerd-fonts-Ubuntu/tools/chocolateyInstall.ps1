...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/Ubuntu.zip'
  checksumType   = 'sha256'
  checksum       = 'EEB1999A9D575E91055A53156B039DDED874D6F3955FF13B9B1B9AC5259C4ABB'
}
