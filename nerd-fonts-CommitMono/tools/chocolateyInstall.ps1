...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/CommitMono.zip'
  checksumType   = 'sha256'
  checksum       = 'E45728B8D5530956C75594BFB625B41C54109B63EE0995A5EA5DC996675DE2EF'
}
