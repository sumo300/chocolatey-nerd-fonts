...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/FiraMono.zip'
  checksumType   = 'sha256'
  checksum       = 'DE42B4D0E1DAD02BA957B7176F457227E1A27CE98CF2026528E61CDCB9A27C9B'
}
