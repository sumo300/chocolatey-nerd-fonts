...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/FiraMono.zip'
  checksumType   = 'sha256'
  checksum       = '16B2E467BDA33C1B6692778CCC3CC3CD860137A5D9F9F90233F10FC6B9D17B58'
}
