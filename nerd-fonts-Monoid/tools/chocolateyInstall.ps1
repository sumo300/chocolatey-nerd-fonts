...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/Monoid.zip'
  checksumType   = 'sha256'
  checksum       = '3F3704711320B7B71EB780AE762BECC1C882C4ED698C00AEC7B2ADAE46F0FA38'
}
