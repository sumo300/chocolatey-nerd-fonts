...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/Monoid.zip'
  checksumType   = 'sha256'
  checksum       = '45D0D64FB7FC28393FB24CAD13D8838C1B3F3C282E4025CFECFD7DD8402045A9'
}
