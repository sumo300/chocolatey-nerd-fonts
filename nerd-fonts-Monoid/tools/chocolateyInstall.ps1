...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/Monoid.zip'
  checksumType   = 'sha256'
  checksum       = 'FC3870185FA30741FA73C870AEC68FBB31D02CA76A97C7FE1EAB1B5E8D9EBCDB'
}
