...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.1/Monoid.zip'
  checksumType   = 'sha256'
  checksum       = '0E228A2841A6625FE8B801F23A0791758CD03BF70F23767882E3751A0306A5ED'
}
