...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/ProFont.zip'
  checksumType   = 'sha256'
  checksum       = 'E8CA1500B6828FC040A4491200DF22E3E299ACACC6E3A53E377E150BB76F9A25'
}
