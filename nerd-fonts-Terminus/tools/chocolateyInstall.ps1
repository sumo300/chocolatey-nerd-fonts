...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.1/Terminus.zip'
  checksumType   = 'sha256'
  checksum       = 'E9CF6D53F49E04D7991F62E1776578547C34EDFE3A22BC2DE412027BE72D75F9'
}
