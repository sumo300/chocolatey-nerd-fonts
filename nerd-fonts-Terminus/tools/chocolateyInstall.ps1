...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/Terminus.zip'
  checksumType   = 'sha256'
  checksum       = '5D98FA61DA2EC501021B621DCFC9D87A81EE5F4B233BE5B630532CB4D76D37F2'
}
