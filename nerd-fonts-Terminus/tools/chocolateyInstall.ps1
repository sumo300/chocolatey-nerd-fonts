...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/Terminus.zip'
  checksumType   = 'sha256'
  checksum       = '8B9ABC2C478A21F1E1775C4F4CA6C754341AC66BADED97CB2B62BBB4D3967868'
}
