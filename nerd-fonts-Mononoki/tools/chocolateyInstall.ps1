...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/Mononoki.zip'
  checksumType   = 'sha256'
  checksum       = '873679BBA5DD2C098A896A967F4FFC1357898285CE0D7EE11F268C7470BC4DA5'
}
