...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/Mononoki.zip'
  checksumType   = 'sha256'
  checksum       = 'C97CF6F9E63D6D1DFEF34AB0B8252E78E2E50523D2A43BDF3F6363F3418DCC4D'
}
