...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/Mononoki.zip'
  checksumType   = 'sha256'
  checksum       = '725689A0F6F308E40E0377F64325C7F2ED8683EA82C282E05ED2283E00E6A7A5'
}
