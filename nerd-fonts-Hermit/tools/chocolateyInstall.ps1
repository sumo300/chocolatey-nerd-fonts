...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/Hermit.zip'
  checksumType   = 'sha256'
  checksum       = '032BDF114DC18A74572427DD1D524367748F1884D6C7ABB46E9A84DACA123329'
}
