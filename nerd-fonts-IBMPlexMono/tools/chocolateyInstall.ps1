...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/IBMPlexMono.zip'
  checksumType   = 'sha256'
  checksum       = 'BAFD403CB0F5F00F6BE982974109D416C97AB9E01BBC33485CF7C2E4E84262BD'
}
