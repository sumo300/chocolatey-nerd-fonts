...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/IBMPlexMono.zip'
  checksumType   = 'sha256'
  checksum       = '260AEEF9FE35BC5003F68D2A3212EF3F4E2B3749E1F1D90C405D63DF40001FCC'
}
