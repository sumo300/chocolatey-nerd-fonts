...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/RobotoMono.zip'
  checksumType   = 'sha256'
  checksum       = '0219D1831DF6BE13FE3A6CDAED4581E4FFFA943FF52DCC23F23FFD2D8E0C1221'
}
