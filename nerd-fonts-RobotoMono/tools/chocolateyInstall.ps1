...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/RobotoMono.zip'
  checksumType   = 'sha256'
  checksum       = '396EC1E33D496EF1AD055D4E1EE0495004A597C9CD172810DA53FEA8C7E5DFC1'
}
