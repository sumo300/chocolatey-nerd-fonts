...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/VictorMono.zip'
  checksumType   = 'sha256'
  checksum       = '0CC0A89BB5F48A822C719E47E004DB4E28D23C3233C6143FBD32BA02EE9CECBE'
}
