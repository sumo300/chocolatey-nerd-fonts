...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/VictorMono.zip'
  checksumType   = 'sha256'
  checksum       = '4A9C26E14A0B94E799C12063CCB2C0BAD17BCD7FC1407E304F73B3BE6B38D913'
}
