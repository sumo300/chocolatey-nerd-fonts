...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/UbuntuSans.zip'
  checksumType   = 'sha256'
  checksum       = 'F349536CCC2663E411A9DB24762F16F30A785159F5FD1F3C24108219CC648557'
}
