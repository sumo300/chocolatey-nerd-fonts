...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/InconsolataGo.zip'
  checksumType   = 'sha256'
  checksum       = 'BBFBC2BA95195CDBE3C2EFDF9FBE667C30110146745698BE485677C3CE591698'
}
