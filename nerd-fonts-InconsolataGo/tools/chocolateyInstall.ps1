...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/InconsolataGo.zip'
  checksumType   = 'sha256'
  checksum       = 'D62B81AB1DEFAC1DCDD265AACCDB8D2F795E7C7F7BA22DCC9C9471C4127C3FF8'
}
