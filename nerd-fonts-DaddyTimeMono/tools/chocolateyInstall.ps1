...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/DaddyTimeMono.zip'
  checksumType   = 'sha256'
  checksum       = 'BBA9CE975F3144BF92E8771BA13ABCEE0E08E2314775D83A58567EF7576DF992'
}
