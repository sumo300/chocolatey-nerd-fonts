...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/ShareTechMono.zip'
  checksumType   = 'sha256'
  checksum       = 'E5EE505434844BC5BFCF4C42FE8895B5A2C8AD2EBC0A82098EFF38BB40866558'
}
