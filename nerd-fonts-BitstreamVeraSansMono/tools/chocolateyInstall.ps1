...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/BitstreamVeraSansMono.zip'
  checksumType   = 'sha256'
  checksum       = '62C7428B355BB4DF234780C1EF4F3100F815F322245205951B54F6D4D91B7CF1'
}
