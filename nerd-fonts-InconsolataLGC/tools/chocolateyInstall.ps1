...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/InconsolataLGC.zip'
  checksumType   = 'sha256'
  checksum       = 'DFACA36B862F1871862629B488A4CC395AAA4D8B6453951BA66ED42F8F29EE57'
}
