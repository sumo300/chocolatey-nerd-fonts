...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/InconsolataLGC.zip'
  checksumType   = 'sha256'
  checksum       = '85BF473D333D7FE22E6A1E27D0BCE188BCFA71DE14B650B1E7C10EF87DBB1547'
}
