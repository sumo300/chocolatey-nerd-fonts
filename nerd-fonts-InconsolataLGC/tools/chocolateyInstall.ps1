...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/InconsolataLGC.zip'
  checksumType   = 'sha256'
  checksum       = '34540145366FC34F1CC558FEE250894A6DCD876446FF84050F28CF2D18760811'
}
