...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/InconsolataLGC.zip'
  checksumType   = 'sha256'
  checksum       = 'D32110C0186D9E5FDEF9CE35DF4F726E17324104E257BD14906AD92C30A2C19E'
}
