...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/SpaceMono.zip'
  checksumType   = 'sha256'
  checksum       = '9E4407FC808322E2CC98A2C234F7DDE947A77ECD4712D1F2B4187D192E43DD35'
}
