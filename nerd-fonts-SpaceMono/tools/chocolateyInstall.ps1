...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/SpaceMono.zip'
  checksumType   = 'sha256'
  checksum       = '5186068BAED57A2687E64C9994A3831DFAC00E370D2FEDC6186A856C1D54C88A'
}
