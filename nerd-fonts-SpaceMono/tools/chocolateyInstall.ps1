...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/SpaceMono.zip'
  checksumType   = 'sha256'
  checksum       = '5CEEB7C75DD0CE747C59A8B921AFB5692038C036FE84BBC1379D57E33F7A1BAF'
}
