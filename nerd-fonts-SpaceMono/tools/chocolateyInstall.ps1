...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/SpaceMono.zip'
  checksumType   = 'sha256'
  checksum       = 'A6C732BF09836A767E23AF2D0BB6B09AC446F268445592407AF518E0749D19C0'
}
