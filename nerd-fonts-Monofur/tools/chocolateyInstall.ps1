...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/Monofur.zip'
  checksumType   = 'sha256'
  checksum       = '37780C2709DA928A603F79924747C9C9C9725AA589A3647363F78E2BB37B1957'
}
