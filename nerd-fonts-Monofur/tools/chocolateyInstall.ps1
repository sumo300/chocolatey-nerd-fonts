...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/Monofur.zip'
  checksumType   = 'sha256'
  checksum       = '1F9FF2A43274D21509320148A7545D6FB8954F271143D85C348D7A5A7C260CBE'
}
