...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/Monofur.zip'
  checksumType   = 'sha256'
  checksum       = '0EDA92D8037100575A540657D59C65478EDD94DC124C93EDA40016F14E079C9C'
}
