...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/Monofur.zip'
  checksumType   = 'sha256'
  checksum       = 'F6386C934D552614AC2B2A61D45EC764B167B2015A1CD99E18A4DF7E0E3FFE1E'
}
