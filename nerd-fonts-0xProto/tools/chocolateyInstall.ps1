...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/0xProto.zip'
  checksumType   = 'sha256'
  checksum       = '96044C9B041DBE6341A2E8B831259BA8E60F4646E55B721B5F6577505381DF1F'
}
