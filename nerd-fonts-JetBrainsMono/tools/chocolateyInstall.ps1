...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/JetBrainsMono.zip'
  checksumType   = 'sha256'
  checksum       = '84E7E6648F9D11D4EFBC0C737DA5061CE9DCEB2C0A8CAFDFA20CB9ADFDCB1A37'
}
