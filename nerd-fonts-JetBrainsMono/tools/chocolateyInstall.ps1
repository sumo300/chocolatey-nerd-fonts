...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/JetBrainsMono.zip'
  checksumType   = 'sha256'
  checksum       = '5B1B315B0D921AC4E7DF6F8CC4F8D54790D6252893CD3BA69AA88810C3FCBF0D'
}
