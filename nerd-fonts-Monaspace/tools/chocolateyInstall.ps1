...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/Monaspace.zip'
  checksumType   = 'sha256'
  checksum       = '30F8BE0241F15616A0A0222334FD55B7F5DE02158F47181D63E6A4EC5389BC0E'
}
