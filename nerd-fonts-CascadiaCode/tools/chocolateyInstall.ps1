...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/CascadiaCode.zip'
  checksumType   = 'sha256'
  checksum       = 'DEBFC4BA14049857C3742963AC2665EA8FF6DB8AB7C5F8C436C69079AE04B9C2'
}
