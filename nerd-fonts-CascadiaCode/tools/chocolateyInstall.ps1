...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/CascadiaCode.zip'
  checksumType   = 'sha256'
  checksum       = 'FE478B6952E42F678C1ACC57612CABC94F6485428DEF6530C181FF1009D9FC1A'
}
