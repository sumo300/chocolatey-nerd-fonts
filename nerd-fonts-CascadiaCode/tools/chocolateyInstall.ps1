...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/CascadiaCode.zip'
  checksumType   = 'sha256'
  checksum       = '34230D1534C70976BC508ABFA9A3B0EC3FAF12881E83B85EB5A0CBE225682256'
}
