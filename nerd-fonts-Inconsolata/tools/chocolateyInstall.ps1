...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/Inconsolata.zip'
  checksumType   = 'sha256'
  checksum       = 'E3094830855C32C7565AF967DCC68082CE97AE6867B318BDD18C38423D64F2DD'
}
