...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/Inconsolata.zip'
  checksumType   = 'sha256'
  checksum       = '369B060DBC72099A53A7260B974FD587D6743E05431FA310C3691D27771DAF3A'
}
