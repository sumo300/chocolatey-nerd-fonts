...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/Overpass.zip'
  checksumType   = 'sha256'
  checksum       = '72FE269A1D0A1918378E90D2D8B2218F612A8979B43DE48965DDE8586E1A20AD'
}
