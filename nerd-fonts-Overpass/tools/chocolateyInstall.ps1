...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/Overpass.zip'
  checksumType   = 'sha256'
  checksum       = '073F3413B7F2DD55562E7C5C6654752F89548D22809BDDAAF124AD0224358425'
}
