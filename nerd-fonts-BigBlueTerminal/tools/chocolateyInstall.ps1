...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/BigBlueTerminal.zip'
  checksumType   = 'sha256'
  checksum       = '2CFB6BAEF22E33AA2EE939F35673518E9CE66A51A22E7EBD71D4D7FEC8AD8DB1'
}
