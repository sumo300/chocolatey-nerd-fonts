...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/BigBlueTerminal.zip'
  checksumType   = 'sha256'
  checksum       = 'C61AA64E5F02329DC1A33B5EAB4AF7E36C1159B81A0A857C8C8882800D609EB1'
}
