...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.0/BigBlueTerminal.zip'
  checksumType   = 'sha256'
  checksum       = 'D0D806D60C52FE54AABED1750800F7DEE5876BB88B5CC7D0D94FC0592F0CDF38'
}
