...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/FiraCode.zip'
  checksumType   = 'sha256'
  checksum       = 'E70D4A8BE94ED056AE0DEED2C24C3389F87CCC1ECB08B4C3DB9D39CE08840A54'
}
