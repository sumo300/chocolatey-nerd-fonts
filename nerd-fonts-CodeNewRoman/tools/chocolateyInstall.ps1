...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.0/CodeNewRoman.zip'
  checksumType   = 'sha256'
  checksum       = '1009AF96C77477AD5A0E2C49DB1BF7CEE5DF7D3029FEBC93DC216D1A0817067C'
}
