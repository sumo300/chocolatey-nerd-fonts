...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.1/CodeNewRoman.zip'
  checksumType   = 'sha256'
  checksum       = 'AD832D2117DCC596FDB7660395E771C0036974D623367B139A3D30EDC549C39E'
}
