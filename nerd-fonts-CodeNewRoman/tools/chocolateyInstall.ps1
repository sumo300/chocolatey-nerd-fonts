...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.0.2/CodeNewRoman.zip'
  checksumType   = 'sha256'
  checksum       = 'A5DC918087C776720860EC8FBF87BA6A43975C91013AC0971366F00324888651'
}
