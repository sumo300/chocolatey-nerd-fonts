...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.0/CodeNewRoman.zip'
  checksumType   = 'sha256'
  checksum       = '2CAAC3FAA3ADC356301A25A99D1E05106BCC875CD5FB67255FDA55CE75306F6F'
}
