...
$packageArgs = @{
  ...
  url            = 'https://github.com/ryanoasis/nerd-fonts/releases/download/v3.1.1/CodeNewRoman.zip'
  checksumType   = 'sha256'
  checksum       = 'AFDF5D952836DD9BAD27A41D9D8AB89B3B70A33C76A8FF9E8987A50FE43BBD7F'
}
